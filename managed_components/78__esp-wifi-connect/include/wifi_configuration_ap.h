...
struct HardwareTestCallbacks {
    std::function<void()> on_start;
    std::function<void()> on_stop;
    std::function<HardwareTestStatus()> get_status;
};
...
public:
    ...
    void SetHardwareTestCallbacks(HardwareTestCallbacks callbacks);
...
private:
    ...
    HardwareTestCallbacks hardware_test_callbacks_;
